...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="address flex flex-column  text-white mb-20 mt-10">
        <span className="po-box uppercase text-5xl tracking-wider mr-5  md:text-6xl lg:text-7xl">
          P.O. Box
        </span>
        <p>
          <span className="po-num text-3xl mb-8">#129</span>{" "}
          <span className="po-state block ">Syracuse, New York 13201</span>
        </p>
      </div>
      ...
      <div className="container">
        ...
        <span>{result} </span>
        <div className="color-pane opacity-50 rounded-3xl">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 201 97">
            <g>
